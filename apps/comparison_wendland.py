...
# comparison_wendland_boxed.py for the tile-grid accelerated version.
# Core primitive script -- part of the four-way comparison (Wendland /
# Gaussian / Shepard / Triangle Soup) used in the report.
#
# Usage:
#   python comparison_wendland.py --target imgs/level_0.png --degraded imgs/level_1.png \
#       --outdir results/comparison_wendland --n 1000 --iters 200
#
# Args:
...
# comparable between "before" and "after" -- matches comparison_wendland_boxed.py.
