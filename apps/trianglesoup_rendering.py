...
# directly to a single target image. Plain O(N) renderer -- see
# trianglesoup_rendering_boxed.py for the tile-grid accelerated version.
# Each triangle has a flat colour and a learnable opacity, composited
# via alpha-over in index order. Uses the C++ TriangleSoupRenderFunction,
# ported from trianglesoup_prototype.py.
#
# Usage:
#   python trianglesoup_rendering.py --image imgs/cat.png --n 1000 --iters 200
#
# Args:
...
OUTDIR = 'results/trianglesoup_rendering'
