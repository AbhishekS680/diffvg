...
#
# Same as comparison_gaussian.py, but uses the tile-grid accelerated
# renderer. Core primitive script -- part of the four-way comparison
# (Wendland / Gaussian / Shepard / Triangle Soup) used in the report.
#
# Usage:
#   python comparison_gaussian_boxed.py --target imgs/level_0.png --degraded imgs/level_1.png \
#       --outdir results/comparison_gaussian_boxed --n 1000 --iters 200
#
# Args:
