...
open('results/trianglesoup_rendering_boxed_no_opacity/softness_log.txt', 'w').close()
...
for t in range(iters):
    ...
    pydiffvg.imwrite(img.detach().clamp(0, 1).cpu(),
                      'results/trianglesoup_rendering_boxed_no_opacity/iter_{}.png'.format(t), gamma=1.0)
...
plt.savefig('results/trianglesoup_rendering_boxed_no_opacity/loss_curve.png', bbox_inches='tight', dpi=150)
plt.close(fig)
...
pydiffvg.imwrite(final.detach().clamp(0, 1).cpu(), 'results/trianglesoup_rendering_boxed_no_opacity/final.png', gamma=1.0)

# -------------------------------------------------------------------
# Visualization: overlay triangle outlines on the final render.
# No opacity variation to reflect, so every outline is drawn at full
# alpha (unlike the learnable-opacity version, which dims outlines by
...
plt.savefig('results/trianglesoup_rendering_boxed_no_opacity/final_labeled.png', bbox_inches='tight', pad_inches=0, dpi=150)
...
ax.axis('off')
plt.savefig('results/trianglesoup_rendering_boxed_no_opacity/movement_quiver.png', bbox_inches='tight', dpi=150)
plt.close(fig)
...
plt.savefig('results/trianglesoup_rendering_boxed_no_opacity/error_heatmap.png', bbox_inches='tight', dpi=150)
plt.close(fig)
...
plt.savefig('results/trianglesoup_rendering_boxed_no_opacity/all_comparison.png', bbox_inches='tight', dpi=150)
plt.close(fig)
...
call(["ffmpeg", "-framerate", "24", "-i",
    "results/trianglesoup_rendering_boxed_no_opacity/iter_%d.png", "-vb", "20M",
    "results/trianglesoup_rendering_boxed_no_opacity/out.mp4"])