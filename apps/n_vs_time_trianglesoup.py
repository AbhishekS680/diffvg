...
with open('results/n_vs_time/n_vs_time_trianglesoup.txt', 'w') as f:
...
print('saved results/n_vs_time/n_vs_time_trianglesoup.txt')
...
ax.legend()
plt.savefig('results/n_vs_time/n_vs_time_trianglesoup.png', bbox_inches='tight', dpi=150)
plt.close(fig)
print('saved results/n_vs_time/n_vs_time_trianglesoup.png')