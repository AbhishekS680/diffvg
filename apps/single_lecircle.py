...
canvas_width = 256
canvas_height = 256
circle = pydiffvg.LeCircle(radius = torch.tensor(40.0),
...
pydiffvg.imwrite(img.cpu(), 'results/single_lecircle/target.png', gamma=2.2)
target = img.clone()
...
img = render(256, # width
             ...
             None,
             *scene_args)
pydiffvg.imwrite(img.cpu(), 'results/single_lecircle/init.png', gamma=2.2)
...
for t in range(100):
    ...
    pydiffvg.imwrite(img.cpu(), 'results/single_lecircle/iter_{}.png'.format(t), gamma=2.2)
...
pydiffvg.imwrite(img.cpu(), 'results/single_lecircle/final.png')

# Convert the intermediate renderings to a video.
from subprocess import call
call(["ffmpeg", "-framerate", "24", "-i",
    "results/single_lecircle/iter_%d.png", "-vb", "20M",
    "results/single_lecircle/out.mp4"])
