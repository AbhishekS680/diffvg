...
print('saved results/n_vs_time/n_vs_time_gaussian_boxed.txt')
...
ax.legend()
plt.savefig('results/n_vs_time/n_vs_time_gaussian_boxed.png', bbox_inches='tight', dpi=150)
plt.close(fig)
print('saved results/n_vs_time/n_vs_time_gaussian_boxed.png')