...
#
# Measures forward+backward render time for Shepard IDW as N (number of
# control points) increases -- one forward+backward pass per N value,
# no training. Feeds into the "Performance Comparison" section of the
...
with open(f'{OUTDIR}/n_vs_time_shepard.txt', 'w') as f:
...
print(f'saved {OUTDIR}/n_vs_time_shepard.txt')
...
ax.legend()
plt.savefig(f'{OUTDIR}/n_vs_time_shepard.png', bbox_inches='tight', dpi=150)
plt.close(fig)
print(f'saved {OUTDIR}/n_vs_time_shepard.png')